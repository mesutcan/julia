...
NOINLINE void gc_mark_loop_unwind(jl_ptls_t ptls, gc_mark_sp_t sp, int pc_offset)
{
    ...
    while (sp.pc < top) {
        ...
        else if (pc == gc_mark_label_addrs[1]) {
            // scan_only
            gc_mark_marked_obj_t *data = gc_repush_markdata(&sp, gc_mark_marked_obj_t);
            if ((char*)data > data_top) {
                jl_safe_printf("Mark stack unwind overflow -- ABORTING !!!\n");
        ...
        else if (pc == gc_mark_label_addrs[2]) {
            // finlist
        ...
        else if (pc == gc_mark_label_addrs[3]) {
            // objarray
        ...
        else if (pc == gc_mark_label_addrs[4]) {
            // obj8
        ...
        else if (pc == gc_mark_label_addrs[5]) {
            // obj16
        ...
        else if (pc == gc_mark_label_addrs[6]) {
            // obj32
        ...
        else if (pc == gc_mark_label_addrs[7]) {
            // stack
        ...
        else if (pc == gc_mark_label_addrs[8]) {
            // module_binding
